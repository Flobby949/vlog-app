	...
	<view>
		...
		<template v-if="!loginStatus">
			<view class="flex align-center p-2" hover-class="bg-light">
				...
				<view class="flex flex-column flex-1 p-2">
		...
		<template v-else>
			...
			<view class="px-3 py-2">
				<image src="/static/demo/banner1.jpg" mode="aspectFill" style="height: 170rpx;width: 100%;"></image>
			</view>

			<uni-list-item title="浏览历史" showExtraIcon><text solt="icon" class="iconfont icon-liulan"></text></uni-list-item>
			<uni-list-item title="社区认证" showExtraIcon><text slot="icon" class="iconfont icon-huiyuanvip"></text></uni-list-item>
			<uni-list-item title="审核帖子" showExtraIcon><text slot="icon" class="iconfont icon-keyboard"></text></uni-list-item>
		</template>
	</view>
</template>
