	...
	<view>
		<uni-list-item title="头像" @click="changeAvatar">
			<view class="flex align-center" slot="right">
				<image :src="avatar ? avatar : '/static/default.jpg'" style="width: 100rpx;height: 100rpx;" class="rounded-circle"></image>
		...
		<view class="py-2 px-3"><button class="bg-main text-white " style="border-radius: 50rpx;border: 0;" type="primary" @click="submit">完成</button></view>
...
export default {
	...
	//监听页面卸载
	onUnload() {
		if (this.$refs.mpvueCityPicker.showCityPicker) {
			this.$refs.mpvueCityPicker.pickerCancel();
		}
	},
	onLoad() {
