	...
	<view>
		<uni-collapse>
			<uni-collapse-item title="标题" showAnimation>
				<view class="content"><input type="text" placeholder="标题" class="border-bottom"/></view>
			</uni-collapse-item>
			<uni-collapse-item title="内容" showAnimation>
				<view class="content"><input type="text" placeholder="内容" class="border-bottom"/></view>
			</uni-collapse-item>
		</uni-collapse>
